...
void waterUpdate(ParticleContainer* container, int x, int y, bool even) {
    ...
    if(self->updated != even){
        ...
        do{
            prevX = x;
            prevY = y;
            if((speedYCopy > 0 && container->getParticle(x, y + 1).getMaterial() == &Materials::air) || container->getParticle(x, y + 1).getMaterial() == &Materials::smoke || container->getParticle(x, y + 1).getMaterial() == &Materials::americaWantsIt) {
                ...
                if((speedYCopy > 0 && container->getParticle(x - 1, y + 1).getMaterial() == &Materials::air) || container->getParticle(x - 1, y + 1).getMaterial() == &Materials::smoke || container->getParticle(x, y + 1).getMaterial() == &Materials::americaWantsIt) {
                    ...
                    self = &container->getParticle(x, y);
                } else if((speedYCopy > 0 && container->getParticle(x + 1, y + 1).getMaterial() == &Materials::air) || container->getParticle(x + 1, y + 1).getMaterial() == &Materials::smoke || container->getParticle(x, y + 1).getMaterial() == &Materials::americaWantsIt) {
                    swapParticles(*self, container->getParticle(x + 1, y + 1));
                    y++;
                    x++;
                    speedYCopy -= 1;
                    ...
                    container->getParticle(x + 1, y + 1).updated = even;
                    self = &container->getParticle(x, y);
                } else if(speedXCopy >= 1 && container->getParticle(x + 1, y).getMaterial() == &Materials::air || container->getParticle(x, y + 1).getMaterial() == &Materials::americaWantsIt) {
